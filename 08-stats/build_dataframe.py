...
def with_aggregated_columns(students_dataframe, columns_without_student_col, with_average_student):
...
def build_dataframe(filename, with_average_student=True):
  ...
  return with_aggregated_columns(students_dataframe, columns_without_student_col, with_average_student)
